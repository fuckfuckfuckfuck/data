/* 20151015, 20151015 must be changed before running */
...
from oneminute where tradingday >= 20151015 and tradingday <= 20151015 
...
where tradingday >= 20151015 and tradingday <= 20151015 
