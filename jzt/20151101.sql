/* 20151028, 20151030 must be changed before running */
...
from oneminute where tradingday >= 20151028 and tradingday <= 20151030 
...
where tradingday >= 20151028 and tradingday <= 20151030 
