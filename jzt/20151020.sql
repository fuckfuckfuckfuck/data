/* 20151020, 20151020 must be changed before running */
...
from oneminute where tradingday >= 20151020 and tradingday <= 20151020 
...
where tradingday >= 20151020 and tradingday <= 20151020 
